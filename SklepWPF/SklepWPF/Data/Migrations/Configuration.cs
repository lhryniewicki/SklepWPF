    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SklepWPF.Data.MyDbContext>
    {
        ...
        protected override void Seed(SklepWPF.Data.MyDbContext context)
        {
            ...
            _db.Messages.AddOrUpdate(new Message
            {
                ...
                Title = "Pytanie o Sambe",
                Content = "Dzien dobry,\nNatrafiłem dzisiaj na następujący problem, chciałbym zrobić sambe dla Szymkowskiego, ale nic nie działa. Moje pytanie w takiej sytuacji brzmi. Czy tede **** jest?\nPozdrawiam, \n\nŁukasz Hryniewicki " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString() + "\n\n",
            ...
            _db.Messages.AddOrUpdate(new Message
            {
                ...
                Senders = new List<User> { user3 },
                Receivers = new List<User> { user1, user2 },
                Title = "Dobre rymy z polskiej krainy",
                Content = "Mam na imię czosnek, kocham to uczucie, kiedy na twej twarzy widać litość i współczucie. Jest - kilka opcji, zacznijmy od litości, popatrz na mój ryj nic nie widać w tej ciemności. \n\nŁukasz Hryniewicki " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString() + "\n\n",
                Created = DateTime.Now,
                LastModified = DateTime.Now,
                AuthorFullName = "Łukasz Hryniewicki",
                ClientSeen = true
            ...
            _db.Messages.AddOrUpdate(new Message
            {
                ...
                Senders = new List<User> { user3 },
                Receivers = new List<User> { user1, user2 },
                Title = "Adam Małysz niespełna rozumu",
                Content = "GADKA SZMATKA, TEN PRZYCHODZI MI Z APARATEM, FILMUJE MNIE, COŚ TAM ********, MÓWI, ***********, COŚ TAM ******** POD SOBĄ, COŚ TAM, ON MÓWI TAKI JEST BYŚ YY JESTEŚ KOZAK ZOZOBACZYŁEM W RZECZYWISTOŚCI, POKAZAŁEM MU MASZ ***********, TAAKI BLONDYN GRUBY WŁOSY DŁUGIE ALE WYGLĄDAŁ BO MIAŁ TAK SPIĘTE WŁOSY \n\nŁukasz Hryniewicki " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString() + "\n\n",
                Created = DateTime.Now,
                LastModified = DateTime.Now,
                AuthorFullName = "Łukasz Hryniewicki",
                ClientSeen = true
            ...
            _db.Messages.AddOrUpdate(new Message
            {
                ...
                Senders = new List<User> { user3 },
                Receivers = new List<User> { user1, user2 },
                Title = "Prezent dla żony",
                Content = "Dzień dobry!\nZbliżają się urodziny mojej cudownej żonki, która właśnie zrobiła mi kawusie. Szukam czegoś, co sprawi, że małżonka będzie krzyczeć. Iwona jest bardzo pojemna, tzn. pojętna i żeby ją zaskoczyć muszę wybrać coś naprawdę dobrego. Co państwo polecają?\nPozdrawiam, \n\nŁukasz Hryniewicki " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString() + "\n\n",
                Created = DateTime.Now,
                LastModified = DateTime.Now,
                AuthorFullName = "Łukasz Hryniewicki",
                ClientSeen = true
            ...
            _db.Messages.AddOrUpdate(new Message
            {
                ...
                Senders = new List<User> { user3 },
                Receivers = new List<User> { user1, user2 },
                Title = "Od braci dla braci",
                Content = "Elo Bolo! Elo Gizmo! Pioooorun. To jest Warszawa. Rap ze stolicy. Cały czas #sztywniutko. A jaaaak. Od braci dla braci. Od dobrych dla dobrych. POLICYJNEJ \n\nŁukasz Hryniewicki " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString() + "\n\n",
                Created = DateTime.Now,
                LastModified = DateTime.Now,
                AuthorFullName = "Łukasz Hryniewicki",
                ClientSeen = true
            ...
            _db.Messages.AddOrUpdate(new Message
            {
                ...
                Senders = new List<User> { user3 },
                Receivers = new List<User> { user1, user2 },
                Title = "Przychodzisz tu z chłopakiem, który bieega",
                Content = "I idziesz i czekasz na moich kolegów, a jak do ciebie przyjdą, to mówisz - tak proszę pana, oczywiście proszę pana.  \n\nŁukasz Hryniewicki " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString() + "\n\n",
                Created = DateTime.Now,
                LastModified = DateTime.Now,
                AuthorFullName = "Łukasz Hryniewicki",
                ClientSeen = true
